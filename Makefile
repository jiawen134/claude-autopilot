...
SCRIPTS := lib/common.sh bin/quality-gate.sh bin/keep-working.sh bin/start-pipeline.sh bin/usage-report.sh bin/dashboard.sh bin/pre-compact.sh bin/session-start.sh bin/subagent-stop.sh bin/permission-gate.sh bin/file-changed.sh
SYNCED_SCRIPTS := .claude/lib/common.sh .claude/hooks/keep-working.sh .claude/hooks/quality-gate.sh .claude/hooks/pre-compact.sh .claude/hooks/session-start.sh .claude/hooks/subagent-stop.sh .claude/hooks/permission-gate.sh .claude/hooks/file-changed.sh
...
sync: ## Copy bin/ to .claude/hooks/ and lib/ to .claude/lib/
	...
	@cp bin/permission-gate.sh .claude/hooks/permission-gate.sh
	@cp bin/file-changed.sh .claude/hooks/file-changed.sh
